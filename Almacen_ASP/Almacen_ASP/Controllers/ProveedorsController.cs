...
namespace Almacen_ASP.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public ProveedorsController(AlmacenHamburgueseriaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProveedor,Nombre,Contacto,HistorialCompras")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProveedor,Nombre,Contacto,HistorialCompras")] Proveedor proveedor)
        {
